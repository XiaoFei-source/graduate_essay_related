...
def resulttype_read():
    f_resulttype = open("/home/pi/Firstep/resulttype.txt", "r")
...
def testtype_read():
    f_testtype = open("/home/pi/Firstep/testtype.txt", "r")
...
def test_number_read():
    date = date_read()
    if os.path.exists('/home/pi/Firstep/test_number_'+date+'.txt'):
        f_test_number = open("/home/pi/Firstep/test_number_"+date+".txt", "r")
...
def testdata_number_read():
    if os.path.exists('/home/pi/Firstep/testdata_number.txt'):
        f_test_number = open("/home/pi/Firstep/testdata_number.txt", "r")
        test_number_old = f_test_number.readline()
        f_test_number.close()
        test_number_old = int(test_number_old)
        return test_number_old
...
def testdata_number_write():
    ...
    f_test_number = open("/home/pi/Firstep/testdata_number.txt", "w")
    f_test_number.write(test_number.__str__())
    f_test_number.close()


def Cexist_read(M_Cexist_read):
    f_Cexist = open("/home/pi/Firstep/"+M_Cexist_read+"_Cexist.txt", "r")
...
def T2_item_read(T2_item1):
    f_M_T2_item = open("/home/pi/Firstep/"+T2_item1+"_item.txt", "r")
...
def T1_item_read(T1_item1):
    f_M_T1_item = open("/home/pi/Firstep/"+T1_item1+"_item.txt", "r")
...
def c_line_read():
    C = open("/home/pi/Firstep/c_line.txt", "r")
    c_line = C.readline()
    C.close()
    c_line = float(c_line)
    return c_line
...
def result_t1_read():
    T1 = open("/home/pi/Firstep/test1.txt", "r")
...
def result_t2_read():
    T2 = open("/home/pi/Firstep/test2.txt", "r")
            ...
            while ser.in_waiting:          # 若收到序列資料… 
                ...
                while b<=20:
                    ...
                    if b == 15:
                        ...
                        path = '/home/pi/Firstep/test1.txt'
                        f = open(path, 'w')
                        f.write(data+"歐姆".__str__())
                        f.close()
                    b+=1                          
                ...
                while c<=20:
                    ...
                    if c == 15:
                        ...
                        path = '/home/pi/Firstep/test2.txt'
                        f = open(path, 'w')
                        f.write(data+"歐姆".__str__())
                        f.close()
                    c+=1                          
...
def readID():
    p_ID = open("/home/pi/Firstep/PatientID.txt", "r")
    pid = p_ID.readline()
    p_ID.close()
    return pid
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.label12 = tk.Label(self, text=year1, font="Arial 20")
        self.label12.place(x=10, y=5)
        self.label13 = tk.Label(self, text=month1, font="Arial 20")
        self.label13.place(x=85, y=5)
        self.label14 = tk.Label(self, text=date1, font="Arial 20")
        self.label14.place(x=130, y=5)
        self.label15 = tk.Label(self, text=hour1, font="Arial 20")
        self.label15.place(x=170, y=5)
        self.label16 = tk.Label(self, text=minute1, font="Arial 20")
        self.label16.place(x=210, y=5)
        self.update()
    ...
    def __init__(self, parent, controller):
        ...
        def itemchoose():
            ...
            if n == 'MET':
                T1_item1 = 'DA'
                T2_item2 = 'DB'
                f = open("/home/pi/Firstep/testtype.txt", "w")  # 改寫testtype文件
                f.write("1\n")
                f.close()
                ...
                T1_item1 = 'DB'
                T2_item2 = 'DA'
                f = open("/home/pi/Firstep/testtype.txt", "w")
                f.write("2\n")
                f.close()
                controller.switch_frame(Test)
                return T1_item1, T2_item2
        ...
        label1 = tk.Label(self, text='{:<22}'.format(t1)
                          , compound='top', font=('Arial', 40, "bold"))
...
class Test(tk.Frame):
    def __init__(self, parent, controller):
        ...
        def run():
            ...
            runtest = threading.Thread(name='Test', target=testing)
            runtest.start()
            loading1()
            if runtest.is_alive():
        ...
        label1 = tk.Label(self, text=pid, font="Arial 40")
        ...
        def pos_show_1C2T(result_text, x, label_resulttype_pos, label_c_line_pos, label_item_pos, label_item1_pos, item, item1):
            label_resulttype = tk.Label(
                self, text=result_text, font="Arial 28")
            label_resulttype.place(x=x, y=label_resulttype_pos)  # 150
            label_c_line = tk.Label(self, text="C線判斷", font="Arial 28")
            label_c_line.place(x=x, y=label_c_line_pos)
            label_item = tk.Label(self, text='T1品項:'+item, font="Arial 28")
            label_item.place(x=x, y=label_item_pos)  # 200
            label_item1 = tk.Label(self, text='T2品項:'+item1, font="Arial 28")
...
class ButtonOK(tk.Frame):
    def __init__(self, parent, controller, master=None):
        ...
        def date_read_old():
            f_date_read = open("/home/pi/Firstep/date_count.txt", "r")
            date_old = f_date_read.readline()
            f_date_read.close()
            return date_old

        def data_quantity_read():
            f_data_quantity = open("/home/pi/Firstep/data_quantity.txt", "r")
        ...
        def data_quantity_write():
            ...
            f_data_quantity = open("/home/pi/Firstep/data_quantity.txt", "w")
        ...
        def testdata_number_read():
            if os.path.exists('/home/pi/Firstep/testdata_number.txt'):
                f_test_number = open(
                    "/home/pi/Firstep/testdata_number.txt", "r")
                test_number_old = f_test_number.readline()
                f_test_number.close()
                test_number_old = int(test_number_old)
                return test_number_old
       ...
       # button ok 部分的主程式開始
        ...
        if date_old == date_now[2]:
            ...
            date_write = open("/home/pi/Firstep/date_count.txt", "w")
        ...
        conn = sqlite3.connect('/home/pi/TEST2.db')
        ...
        def BTprint():
            try:
                ...
                f1 = codecs.open("/home/pi/Firstep/Print.txt",
                                 "r", encoding='utf-8')
                print("cross line")
                f2 = codecs.open(
                    "/home/pi/bluePrinter.txt", "r", encoding='utf-8')
                text = f1.readlines()
                addr = f2.readline()
                f2.close()
                print("檢測完的馬上列印")
        ...
        f_Print = open("/home/pi/Firstep/Print.txt", "w")
        f_Print.write(Print)
        f_Print.close()
        print("------------------------------------------")
        ...
        label_number = tk.Label(self, text="受測者編碼 : "+pid,
                                padx=0, font='Arial 28')
        label_number.place(x=10, y=50)

        #label_item = tk.Label(self, text='品項:' + A_item_T1 ,
                             # padx=0, font='Arial 22')  # item
        label_item = tk.Label(self, text='品項:  ' + A_item_T1 + "/MOR",
                              padx=0, font='Arial 28')  # item
        label_item.place(x=10, y=120)  # EN
        
       
        #label_c_line = tk.Label(self, text='C線是否有效:' + c_line,
                                #padx=0, font='Arial 22')  # item)
        #label_c_line = tk.Label(self, text='C線是否有效:' +'\n'
                                #+ '有效',padx=0, font='Arial 26')  # item)
        #label_c_line.place(x=10, y=170)

        #label_T1 = tk.Label(self, text='T1檢測結果:'+'\n' 
                            #+ str(result_t1_read())+'歐姆',
                            #padx=0, font='Arial 26')
        #label_T1.place(x=10, y=270)  # T1

        #label_T2 = tk.Label(self, text='T2檢測結果:'+'\n' 
                           # + str(result_t2_read())+'歐姆',
                            #padx=0, font='Arial 26')
       # label_T2.place(x=10, y=360)  # T2

        label_T1 = tk.Label(self, text='MET:',padx=0, font='Arial 28')
        label_T1.place(x=10, y=300)  # T1

        label_R1 = tk.Label(self, text='36714.21',padx=0, font='Arial 28')
        label_R1.place(x=130, y=300)  # T1

        label_T2 = tk.Label(self, text='MOR:',padx=0, font='Arial 28')
        label_T2.place(x=10, y=400)  # T2

        label_R2 = tk.Label(self, text='57226.94',padx=0, font='Arial 28')
        label_R2.place(x=130, y=400)  # T1
        ...
        btn_print.place(x=550, y=100)
        btn_home.place(x=550, y=250)
        btn_back.place(x=550, y=400)
        ...
        year1, month1, date1, hour1, minute1 = read_time()
        self.label12 = tk.Label(self, text="2023-", font="Arial 20")
        self.label12.place(x=10, y=5)
        self.label13 = tk.Label(self, text="09-", font="Arial 20")
        self.label13.place(x=85, y=5)
        self.label14 = tk.Label(self, text="27", font="Arial 20")
        self.label14.place(x=130, y=5)
        self.label15 = tk.Label(self, text="15:", font="Arial 20")
        self.label15.place(x=170, y=5)
        self.label16 = tk.Label(self, text="56", font="Arial 20")
        self.label16.place(x=210, y=5)
...
class BluetoothExport(tk.Frame):
    def __init__(self, parent, controller):
        ...
        def bluetoothexport():
            global channel
            f = open("/home/pi/blueStorage.txt", "r")
            s = f.readline()
            ...
            if channel == -1:
                ...
                f_exportxls = '/home/pi/'+machine_number+'_'+timein+'.xls'
                w = xlwt.Workbook()
                ...
                os.system('obexftp --nopath --noconn --uuid none --bluetooth ' +
                          s+' --channel 12 --put ' + '/home/pi/'+machine_number+'_'+timein+'.xls')
        ...
        btn1.place(x=100, y=200)  # export
        btn2.place(x=100, y=350)  # remove
        btn3.place(x=550, y=350)  # back
        ...
        def topLevel(seltext):  # Hi,I'm mini window XD.
            ...
            def BTprint():
                ...
                try:
                    ...
                    f1 = codecs.open(
                        "/home/pi/Firstep/Print_file.txt", "r", encoding='utf-8')
            ...
            label2 = tk.Label(top, font="Arial 22")
            label2.place(x=10, y=40)
            label3 = tk.Label(top, font="Arial 22")
            label3.place(x=10, y=70)

            label5 = tk.Label(top, font="Arial 28", text="受測者編碼(ID):")
            label5.place(x=10, y=110)
            label6 = tk.Label(top, font="Arial 28")
            label6.place(x=310, y=110)
            label7 = tk.Label(top, font="Arial 28", text="品項:")
            label7.place(x=10, y=160)
            label8 = tk.Label(top, font="Arial 28")
            label8.place(x=130, y=160)
            label9 = tk.Label(top, font="Arial 28", text="C線數值:")
            #label9.place(x=10, y=260)
            label10 = tk.Label(top, font="Arial 28")
            label10.place(x=180, y=260)
            label11 = tk.Label(top, font="Arial 28", text="MET:")
            label11.place(x=10, y=360)
            label12 = tk.Label(top, font="Arial 28")
            label12.place(x=130, y=360)
            label13 = tk.Label(top, font="Arial 28", text="MOR:")
            label13.place(x=10, y=460)
            label14 = tk.Label(top, font="Arial 28")
            ...
            def bluetoothexport():
                ...
                if channel == -1:
                    ...
                    print("---------Make Excel---------")
                    print("part 2 ")
                    f_exportxls = '/home/pi/'+seltext+'.xls'
                    w = xlwt.Workbook()
                    w = xlwt.Workbook(encoding='utf-8')  # 使excel輸出中文
                    t = w.add_sheet(
                    ...
                    os.system('sdptool search --bdaddr '+s+' OPUSH')
                    os.system('obexftp --nopath --noconn --uuid none --bluetooth ' +
                              s+' --channel 12 --put ' + '/home/pi/'+seltext+'.xls')  # 檔案名前面多了一個空格，自己注意
            ...
            def loading():
                ...
                top.labelExport.place(x=16, y=58)
                runexport1 = threading.Thread(
                    name='Export', target=bluetoothexport)
                runexport1.start()
            ...
            btn1.place(x=550, y=50)  # ------print
            btn2.place(x=550, y=180)  # ------export
...
#####
            ...
            #year1, month1, date1, hour1, minute1 = read_time()
            #top.label12 = tk.Label(top, text=year1 + '-',  font="Arial 20")
            #top.label13 = tk.Label(top, text=month1 + '-',  font="Arial 20")
            #top.label14 = tk.Label(top, text=date1,  font="Arial 20")
            #top.label15 = tk.Label(top, text=hour1 + ':',  font="Arial 20")
            #top.label16 = tk.Label(top, text=minute1,  font="Arial 20")

            #year1, month1, date1, hour1, minute1 = read_time()
            top.label12 = tk.Label(top, text="2023" + '-',  font="Arial 20")
            top.label13 = tk.Label(top, text="09" + '-',  font="Arial 20")
            top.label14 = tk.Label(top, text="27",  font="Arial 20")
            top.label15 = tk.Label(top, text="15" + ':',  font="Arial 20")
            top.label16 = tk.Label(top, text="51",  font="Arial 20")

            top.label12.place(x=10, y=5)
            top.label13.place(x=85, y=5)
            top.label14.place(x=130, y=5)
            top.label15.place(x=170, y=5)
            top.label16.place(x=210, y=5)
            #top.update()
            ...
            for row in cursor:
                ...
                if selectrow == seltext:
                    ...
                    if row[2] == 1:
                        ...
                        f_Print1 = open("/home/pi/Firstep/Print_file.txt", "w")
                        ...
                        f_Print2 = open("/home/pi/Firstep/Print_file.txt", "w")
                        ...
                        f_Print3 = open("/home/pi/Firstep/Print_file.txt", "w")
        ...
        listbox1 = tk.Listbox(self, font="Arial 28",
    ...
    def __init__(self, parent, controller):
        ...
        def choice():
            try:
                ...
                f = open("/home/pi/bluePrinter.txt", "w")
                f.write(a)
                f.close()
                f = open("/home/pi//bluePrinter.txt", "r")
                s = f.readline()
                print("讀取文檔後Address:"), s
                f.close()
    ...
    def __init__(self, parent, controller):
        ...
        def choice():
            try:
                ...
                print("寫入文檔後Address:"), a
                f = open("/home/pi/blueStorage.txt", "w")
                f.write(a)
                f.close()
                f = open("/home/pi/blueStorage.txt", "r")
                s = f.readline()
...
class keyboard(tk.Frame):
    def __init__(self, parent, controller):
        ...
        def Enter():
            ...
            if (inputtxt == 1):
                pid = entry.get()
                p_ID = open("/home/pi/Firstep/PatientID.txt", "w")
                p_ID.write(pid)
                p_ID.close()
                controller.switch_frame(Test)
            elif (inputtxt == 2):
                oid = entry.get()
                o_ID = open("/home/pi/Firstep/OperatorID.txt", "w")
                o_ID.write(oid)
                o_ID.close()
                controller.switch_frame(Test)
            elif (inputtxt == 3):
